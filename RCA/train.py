...
def get_arguments():
    ...
    parser.add_argument("--img_dir", type=str, default='VOC2012/JPEGImages')
    parser.add_argument("--train_list", type=str, default='VOC2012/ImageSets/Segmentation/train_cls.txt')
    parser.add_argument("--test_list", type=str, default='VOC2012/ImageSets/Segmentation/val_cls.txt')
...
def train(args):
    ...
    if args.resume != '':
        ...
        current_epoch = saved_state['epoch'] + 1
        global_counter = saved_state['global_counter']
    ...
    while current_epoch < total_epoch:
        ...
        current_epoch += 1
    save_checkpoint(args, {'epoch': current_epoch, 'global_counter': global_counter, 'state_dict':model.state_dict(), 'optimizer':optimizer.state_dict()}, is_best=False, filename='%s_epoch_%d.pth' %(args.dataset, current_epoch))
