...
if __name__ == '__main__':
    ...
    train_lst = 'VOCdevkit/VOC2012/ImageSets/Segmentation/train_cls.txt'
    root_folder = 'VOCdevkit/VOC2012'
    im_lst, label_lst = load_dataset(train_lst)
    
    atten_path = 'runs/pascal/feat'
    save_path = 'runs/pascal/orig'
    if not exists(save_path):
        os.mkdir(save_path)
    for i in tqdm(range(len(im_lst))):
